...
import com.jiesai.camera.Utils.photo.BitmapCache;
import com.jiesai.camera.Utils.photo.ImageItem;
import com.jiesai.camera.Utils.photo.Res;
...
//			viewHolder.imageView.setLayoutParams(lp);
		...
		if (path.contains("camera_default")) {
			viewHolder.imageView.setImageResource(Res.getDrawableID("photo_plugin_camera_no_pictures"));
		} else {
